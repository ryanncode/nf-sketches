# <div align="center">The NF Sketches Lab</div>

_A proof-theoretic engine utilizing Lean 4 for_ $O(V+E)$ _topological bounds checking to enable acyclic combinatory graph reduction._
...
_(The engine will natively isolate and analyze the recursive boundaries of this comprehension.)_
